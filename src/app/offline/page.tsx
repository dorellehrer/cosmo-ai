      ...
      <div className="text-center max-w-md">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full px-6 py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 rounded-full text-white font-semibold transition-all shadow-lg shadow-violet-500/25"
          >
            Try Again
          </button>
          ...
          <Link
            href="/"
            className="block w-full px-6 py-3 border border-white/20 hover:bg-white/10 rounded-full text-white font-semibold transition-all text-center"
          >
            Go to Home
          </Link>
        </div>
        ...
        <div className="mt-12 flex items-center justify-center gap-2 opacity-50">
          ...
          <span className="text-sm text-white/60">Cosmo AI</span>
        </div>
      </div>
    </div>
  );
