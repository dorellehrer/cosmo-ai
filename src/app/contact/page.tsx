...
const socialLinks = [
  ...
  },
  {
    ...
    url: 'https://linkedin.com/company/cosmo-ai',
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@cosmo.ai" className="text-white hover:text-violet-300 transition-colors">
                      hello@cosmo.ai
                    </a>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@cosmo.ai" className="text-white hover:text-violet-300 transition-colors">
                      support@cosmo.ai
                    </a>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:press@cosmo.ai" className="text-white hover:text-violet-300 transition-colors">
                      press@cosmo.ai
                    </a>
                  </div>
                </div>
