...
const INTEGRATION_DETAILS: Record<string, {
  ...
  google: {
    ...
    fullDescription: 'Connect your Google account to manage Calendar events, send and read emails via Gmail, and search Drive files.',
    features: ['View, create, update, and delete calendar events', 'Read email summaries and send emails', 'Search files in Drive', 'Full calendar management'],
  },
  hue: {
    brandIcon: (
    ...
    fullDescription: 'Connect Philips Hue to control your smart lights, activate scenes, and adjust brightness and colors through Nova.',
    features: ['Control individual lights', 'Activate scenes', 'Adjust brightness and color', 'List all lights and scenes'],
  },
  spotify: {
    brandIcon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8">
    ...
    fullDescription: 'Connect Spotify to control playback, check what\'s playing, browse playlists, and search for songs, artists, and albums through Nova.',
    features: ['Play, pause, and skip tracks', 'Check currently playing track', 'Browse your playlists', 'Search for music'],
  },
  sonos: {
    brandIcon: (
    ...
    fullDescription: 'Connect Sonos to control multi-room audio, adjust volume, and manage speaker groups through Nova.',
    features: ['Multi-room audio control', 'Play, pause, and skip tracks', 'Volume control', 'List speaker groups'],
  },
  notion: {
    brandIcon: (
    ...
    fullDescription: 'Access your Notion workspace. Search pages, create and update notes, and manage your databases with natural language.',
  ...
  slack: {
    ...
    fullDescription: 'Connect Slack to search messages, send messages to channels, send DMs, reply in threads, and browse your team communication through Nova.',
    features: ['Search workspace messages', 'Send messages to channels', 'Send direct messages', 'Reply in threads'],
  },
  whatsapp: {
    brandIcon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8">
    ...
    fullDescription: 'Connect WhatsApp to send and read messages, manage contacts, and interact with group chats through Nova.',
    features: ['Send messages', 'Read messages', 'Manage contacts', 'Group chats'],
  },
  discord: {
    brandIcon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8">
    ...
    fullDescription: 'Connect Discord to manage server communication, send messages to channels, and interact with your communities through Nova.',
    features: ['Send messages to channels', 'Read messages', 'Manage servers', 'Direct messages'],
  },
  phone: {
    brandIcon: (
    ...
    fullDescription: 'Make AI-powered phone calls through Nova. Schedule calls, get transcripts, and receive call summaries automatically.',
    features: ['Make AI-powered calls', 'Schedule calls', 'Call summaries', 'Full transcripts'],
  },
};
      ...
      >
        ...
        <div className={`p-6 bg-gradient-to-br ${integration.color} relative`}>
          ...
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center">
              {details?.brandIcon ?? <span className="text-3xl">{integration.icon}</span>}
            </div>
            <div>
        ...
        <div className="p-6">
          {isConnecting ? (
            ...
            <>
              <p className="text-white/70 text-sm mb-4">{details?.fullDescription ?? integration.description}</p>

              <div className="mb-6">
                <h3 className="text-white font-medium mb-2 text-sm">What Nova can do:</h3>
                <ul className="space-y-2">
                  {(details?.features ?? integration.services ?? []).map((feature, index) => (
                    ...
                    <div className="flex items-center gap-3">
                      <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${integration.color} p-0.5`}>
                        <div className="w-full h-full rounded-[10px] bg-slate-900 flex items-center justify-center">
                          {details?.brandIcon ?? <span className="text-2xl">{integration.icon}</span>}
                        </div>
                      </div>
                      <div>
