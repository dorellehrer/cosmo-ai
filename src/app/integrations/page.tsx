...
const INTEGRATION_DETAILS: Record<string, {
  ...
  spotify: {
    ...
    features: ['Play, pause, and skip tracks', 'Check currently playing track', 'Search for music', 'Discover new music'],
  },
  sonos: {
    brandIcon: (
  ...
  notion: {
    ...
    features: ['Search pages and databases', 'Create new pages', 'Quick capture notes', 'Browse your workspace'],
  },
  slack: {
    brandIcon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8">
    ...
    features: ['Search workspace messages', 'Send messages to channels', 'List channels', 'Stay updated'],
  },
};
            ...
            return (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  ) : ['hue', 'sonos'].includes(integration.id) ? (
                    <div className="w-full py-2.5 rounded-xl font-medium text-white/40 bg-white/5 text-center text-sm cursor-not-allowed">
                      Coming Soon
                    </div>
                  ) : (
                    <button
